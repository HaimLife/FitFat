...
$(document).ready(function() {
    ...
    $(".addFood").click(function() {
        ...
        $.getJSON("http://localhost:1044/FoodToCalories.svc/GetCalories?food=" + foodName, function(data) {
            ...
            $(".foodList").append("<div class='list-group-item' id='" + foodId + "'> <span class='glyphicon glyphicon-remove btn removeFood'></span>" + foodName + " <span class='foodUnit'> " + foodQuantity + " " + foodUnit + "</span></div>");
            foodIndex++;
